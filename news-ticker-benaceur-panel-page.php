...
<?php if (isset($_GET['settings-updated']) && $GLOBALS['pagenow'] == NTB_BEN_O_G && $_GET['page'] == NS_TR_BEN){ ?>
<style>
...
?>
				</select><div style="position:absolute;margin-top:-78px; margin-left:185px; margin-right:185px;" class="ntb-new"></div></div>
				</td>
                </tr>
</table>
...
<?php $ntb_post__status = (array) $ntb_post_status; ?>
				...
				<div style="position:absolute;margin-top:-78px; margin-left:185px; margin-right:185px;" class="ntb-new"></div></div>
				</td>
                </tr>
</table>
...
<table style="margin-top:35px; margin-bottom:-60px;" class="form-table">
				...
				</select><div style="position:absolute;margin-top:-19px; margin-left:185px; margin-right:185px;" class="ntb-new"></div></div>
				</td>
                </tr>
</table>
...
#wpcontent-benaceur-ntb input:focus:-ms-placeholder { color:transparent; }
	  ...
	  <?php if ($GLOBALS['pagenow'] == ''.NTB_BEN_O_G.'' && $_GET['page'] == ''.NS_TR_BEN.'') { 
