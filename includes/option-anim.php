...
<table class="form-table">
                ...
                <tr class="fsub_lat-com-ntb box_lat-com" valign="top">
                    ...
                    <td>
					<div class="sm_benaceurlist_caps_input-ntb"><input style="font-weight:bold;max-width:100px;text-align:center;" type="text" name="news_ticker_benaceur_expt_title_scrollntb" value="<?php echo $ntb_expt_title_scrollntb; ?>" /><div style="position:absolute;margin-top:-28px; margin-left:175px; margin-right:175px;" class="ntb-new"></div></div>
                   </td>
                </tr>
                <tr valign="top">
				<?php if (is_rtl() && $dir != 'ltr' || !is_rtl() && $dir == 'rtl') { ?>
                ...
                <tr class="fsub_lat-com-ntb box_lat-com">  
                    ...
                    <td> 
					<label class="switch-nab">				
	                    <input type="checkbox" class="switch-input" name="news_ticker_benaceur_all_scrollntb" value="1" <?php if( !empty($ntb_all_scrollntb)) { echo 'checked="checked"'; } ?>/><div style="position:absolute;margin-top:5px; margin-left:175px; margin-right:175px;" class="ntb-new"></div>
                        <span class="switch-label" data-on="On" data-off="Off"></span>
                        <span class="switch-handle"></span>
                   </label>
				   </td>
...
<table class="form-table">
				...
				<?php } ?>
					<td>
					<div class="sm_benaceurlist_caps_input-ntb"><input style="font-weight:bold;max-width:100px;text-align:center;" type="text" name="news_ticker_benaceur_dis_fin_img_scrollntb" value="<?php echo $ntb_dis_fin_img_scrollntb; ?>" /><div style="position:absolute;margin-top:-28px; margin-left:175px; margin-right:175px;" class="ntb-new"></div></div>
                   </td>
                </tr>
                <tr valign="top">
				<?php if (is_rtl() && $dir != 'ltr' || !is_rtl() && $dir == 'rtl') { ?>
				...
				<?php } ?>
					<td>
					<div class="sm_benaceurlist_caps_input-ntb"><input style="font-weight:bold;max-width:100px;text-align:center;" type="text" name="news_ticker_benaceur_dis_fin_no_img_scrollntb" value="<?php echo $ntb_dis_fin_no_img_scrollntb; ?>" /><div style="position:absolute;margin-top:-28px; margin-left:175px; margin-right:175px;" class="ntb-new"></div></div>
                   </td>
                </tr>
					<tr>
						<td>
                ...
                <tr>  
					...
					<label class="switch-nab">				
                        ...
                        <span class="switch-label" data-on="On" data-off="Off"></span>
                        <span class="switch-handle"></span>
                   </label><div style="position:absolute;margin-top:-19px; margin-left:175px; margin-right:175px;" class="ntb-new"></div>
				   </td>
                </tr>
</table>
</br>
